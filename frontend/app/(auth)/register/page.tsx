                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-2.5 top-1.5 z-10 p-1.5 rounded-lg text-slate-400 hover:text-[#FF9900] hover:bg-slate-200/60 dark:hover:bg-slate-800/80 transition-all cursor-pointer flex items-center justify-center"
