    ...
    <div className="min-h-screen py-6 flex items-center justify-center p-4 lg:px-8 bg-[#f8fafc] dark:bg-[#050810] selection:bg-[#FF9900] selection:text-white">
      <div className="w-full max-w-[1300px] grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-4">
        ...
        <div className="lg:col-span-5 w-full flex items-center justify-end">
          <div className="bg-white dark:bg-slate-900 rounded-[28px] p-6 sm:p-8 border border-slate-200/80 dark:border-slate-800 shadow-2xl shadow-slate-300/40 dark:shadow-none flex flex-col gap-4.5 w-full">
            
            {/* Back to Home Button */}
            <Link
              href="/"
              className="flex items-center gap-1.5 text-[11px] font-bold text-slate-500 hover:text-[#FF9900] transition-colors w-fit"
            >
            ...
            {successMsg && (
              <div className="p-3 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-medium">
                {successMsg}
              </div>
            )}
            ...
            {step === "DETAILS" ? (
              <form onSubmit={handleSendOtp} className="flex flex-col gap-3">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-xl text-xs border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 focus:outline-none focus:border-[#FF9900] font-medium text-slate-900 dark:text-white transition-all shadow-sm"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-2.5 top-2 z-20 w-7 h-7 rounded-lg text-slate-400 hover:text-[#FF9900] hover:bg-slate-200/60 dark:hover:bg-slate-800/80 transition-all flex items-center justify-center cursor-pointer select-none"
                ...
                <div className="text-center mt-1">
                  ...
                  <Link href="/login" className="text-xs font-bold text-[#FF9900] hover:underline">
                    Sign In to Portal →
                  </Link>
                </div>
              </form>
              ...
              <form onSubmit={handleVerifyOtp} className="flex flex-col gap-5">
                <div className="p-3 rounded-xl bg-blue-50 dark:bg-blue-500/10 border border-blue-200 text-xs font-medium text-slate-700 dark:text-slate-300">
                  We sent a 6-digit verification code to <strong>{email}</strong>. Check your inbox.
                </div>
                ...
                <div className="flex items-center justify-between gap-2">
                  {otp.map((digit, idx) => (
                    <input
                      ...
                      className="w-11 h-12 text-center text-xl font-mono font-bold rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:outline-none focus:border-[#FF9900] shadow-sm"
                    />
                  ))}
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3.5 rounded-xl font-bold text-xs text-slate-950 bg-gradient-to-r from-[#FF9900] via-amber-400 to-orange-400 hover:from-amber-400 hover:to-orange-500 shadow-lg shadow-[#FF9900]/25 flex items-center justify-center gap-2 transition-all"
                >
                  {isLoading ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin" />
