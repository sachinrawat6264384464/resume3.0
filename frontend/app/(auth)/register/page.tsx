  ...
  return (
    <div className="h-[calc(100vh-4rem)] max-h-[calc(100vh-4rem)] overflow-hidden flex items-center justify-center p-2 sm:p-4 lg:px-6 bg-[#f8fafc] dark:bg-[#050810]">
      <div className="w-full max-w-[1300px] grid grid-cols-1 lg:grid-cols-12 gap-5 items-center h-full max-h-full py-1">
        ...
        {/* Right Column: Premium Glassmorphic Registration Card */}
        <div className="lg:col-span-5 w-full flex items-center justify-end">
          <div className="relative w-full rounded-[32px] overflow-hidden">
            ...
            <div className="relative bg-white/90 dark:bg-slate-900/95 backdrop-blur-xl rounded-[32px] p-6 sm:p-8 border border-[#FF9900]/20 dark:border-[#FF9900]/15 shadow-2xl shadow-[#FF9900]/10 dark:shadow-[#FF9900]/5 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2.5 mb-0.5">
                  ...
                  <div>
                    ...
                    <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider leading-none">Candidate Assessment OS</span>
                  </div>
                </div>
              ...
              {step === "DETAILS" ? (
                <form onSubmit={handleSendOtp} className="flex flex-col gap-3.5">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[11px] font-black text-slate-600 dark:text-slate-300 uppercase tracking-wider">Full Name</label>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[11px] font-black text-slate-600 dark:text-slate-300 uppercase tracking-wider">Email</label>
                      <div className="relative group">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-3 py-3.5 rounded-2xl text-sm border-2 border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 focus:outline-none focus:border-[#FF9900] focus:bg-white dark:focus:bg-slate-900 font-medium text-slate-900 dark:text-white transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600"
                          placeholder="you@example.com"
                        />
                      </div>
                    </div>
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[11px] font-black text-slate-600 dark:text-slate-300 uppercase tracking-wider">Phone</label>
                      <div className="relative group">
                  ...
                  {/* Password */}
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[11px] font-black text-slate-600 dark:text-slate-300 uppercase tracking-wider">Password</label>
                    <div className="relative group">
                ...
                <form onSubmit={handleVerifyOtp} className="flex flex-col gap-5">
                  <div className="p-3.5 rounded-2xl bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-800 text-xs font-medium text-slate-700 dark:text-slate-300 flex items-start gap-2">
